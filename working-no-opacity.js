...
g
    .attr(
        "transform", 'translate(130,-20) scale(0.34)'
    )
        ...
        ageG.append("g")
            ...
            .on("mouseout", function(d,i){
                if (d.properties.density !== undefined && update) {
                    ...
                    d3.select(this).attr("fill", "#bb9999")
                }
                tooltip.transition()
                    .duration(500)
                    .style("opacity", 0);
    ...
    function column(title, scale) {
        ...
        if(type == 'ethnic'){
            var legendsvg = div.insert("div", "#map__container + *").attr("class", "col-2 legend"+type)
                            .style("padding", "0px").style("margin-left", "-40px").append("svg").attr("height", "100%").attr("width", "200px");
        }
        if(type == 'age'){
