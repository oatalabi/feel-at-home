...
var ethnicColor = d3.scaleThreshold().domain([0, 500, 1000, 10000, 50000, 100000, 500000]).range(['rgb(34, 47, 62, 0.08)', 'rgb(34, 47, 62, 0.2)', 'rgb(34, 47, 62, 0.35)', 'rgb(34, 47, 62, 0.48)', 'rgb(34, 47, 62, 0.6)', 'rgb(34, 47, 62, 0.8)', 'rgb(34, 47, 62, 1)']);
var color_14 = d3.scaleThreshold().domain([0, 500, 1000, 10000, 50000, 100000, 500000]).range(['rgb(238, 82, 83, 0.08)', 'rgb(238, 82, 83, 0.17)', 'rgb(238, 82, 83, 0.35)', 'rgb(238, 82, 83, 0.5)', 'rgb(238, 82, 83, 0.65)', 'rgb(238, 82, 83, 0.8)', 'rgb(238, 82, 83, 1)']);
...
g
    .attr(
        "transform", 'translate(130,10) scale(0.23)'
    )
...
function drawLegend(type, threshold) {
    ...
    function column(title, scale) {
        ...
        if (type == 'ethnic') {
            var legendsvg = div.insert("div", "#map__container + *").attr("class", "col-2 legend" + type)
                .style("padding", "0px").append("svg").attr("height", "100%").attr("width", "200px");
        }
        if (type == 'age') {
            var legendsvg = d3.select("div", "#age_map__container + *").attr("class", "col-2 legend" + type)
                .style("padding", "0px").append("svg").attr("height", "100%").attr("width", "200px");
        }
...
function drawAgeGraph(data) {
    ...
    function mouseover(d) {
        ...
        // if ((focused_14 || focused_64 || focused_65) && selected ){
        //     newData = eval(d3.select('#ethnicity').property('value'));
        //     console.log(newData, '========')
        //     addDensity(newData, 'ethnic')
        //     console.log('there is ethnicity and age together=======')
        // }
    }
